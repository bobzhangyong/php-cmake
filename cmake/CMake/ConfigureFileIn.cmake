...
MACRO(configure_file_in SOURCE TARGET)
  ...
  message("CONFIGURE_FILE ${CMAKE_CURRENT_SOURCE_DIR}/${DIR}/${SOURCE} ${CMAKE_CURRENT_SOURCE_DIR}/${DIR}/${TARGET}")
  configure_file(${CMAKE_CURRENT_SOURCE_DIR}/${DIR}/${SOURCE} ${CMAKE_CURRENT_SOURCE_DIR}/${DIR}/${TARGET})
  # Add -DHAVE_{TARGET}.
#  add_definitions(-DHAVE_${TARGET})
  # Make sure TARGET can be found.
  message("INCLUDE_DIRECTORIES ${CMAKE_CURRENT_SOURCE_DIR}/${DIR}")
